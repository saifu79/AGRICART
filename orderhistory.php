<?php
	...
	$query = "SELECT * FROM orders,product WHERE customer_id=$user_id and product.product_id=orders.product_id";
	$result = mysqli_query($connect,$query);
	$output=$order_id=$product_title=$Description=$date=$price="";
