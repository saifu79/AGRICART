		...
		while($row = mysqli_fetch_array($result))
		{
			...
			$output .= '<tr class="font">
						  ...
						  <td>
							...
							<form action="method1.php" method="POST"><button type="submit" name="approve" value="'.$sell_id.'" class="btn btn-success">Approve</button></form>
							<form action="method1.php" method="POST"><button type="submit" name="decline" value="'.$sell_id.'" class="btn btn-danger">Decline</button></form>
							</div>
						  </td>
...
<div class=" row" style="margin-left: -100px;margin-right: 150px;">
	...
	<div class="col-md-3 col-sm-3 col-xs-6">
        <a data-toggle="tooltip" title="4 new product requests" class="well top-block active" style="height: 80px;" href="approve-product.php">
            <i class="glyphicon glyphicon-star green"></i>

            <div style="margin-top:15px;">Grant/Decline products</div>
            <div>100</div>
            <span class="notification green">4</span>
        </a>
    </div>
...
<div class="row" style="margin-left: -245px;">
  ...
  <thead class="thead-dark">
    <tr style="font-weight: bold;font-size: 18px;">
      <th scope="col"; width="8px">S.No</th>
      <th scope="col"; width="8px">type</th>
      <th scope="col"; width="8px">category</th>
      <th scope="col">brand</th>
      <th scope="col"; width="8px">title</th>
      <th scope="col">price</th>
	  <th scope="col"; width="8px">quantity</th>
      <!--<th scope="col"; width="12px">description</th> -->
