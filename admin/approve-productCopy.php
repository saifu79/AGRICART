		...
		while($row = mysqli_fetch_array($result))
		{
			...
			$output .= '<tr class="font">
						  ...
						  <td>'.$shop_id.'</td>
							...
							<form action="method.php" method="POST"><button type="submit" name="approve" value="'.$type.'" class="btn btn-success">Approve</button></form>
							<form action="method.php" method="POST"><button type="submit" name="decline" value="'.$type.'" class="btn btn-danger">Decline</button></form>
							</div>
						  </td>
						  </td>
						</tr>
