...
$connect = mysqli_connect($servername, $username, $password, $database);*/
	if(isset($_POST['approve']))
	{
		...
		if($result)
		{
			...
			$pr=10;
			$que="INSERT INTO product(product_id,type,category,brand,title,price,quantity,description,shop_id) VALUES($pr,'$type','$category','$brand','$title',$price,$quantity,'$description',$shop_id)";
