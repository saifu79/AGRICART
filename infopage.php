...
<body>
	<div class="heading">
			...
			<ul style="list-style-type:none;padding-left:135px;padding-top:20px;">
				<li class="lfloat"><a href="login.php" class="rightside-list" style="padding-right:25px;">Login &amp; Signup</a></li>
				<li class="lfloat"><a href="cart.php" class="rightside-list" ><i class="fa fa-shopping-cart"></i> Cart</a></li>
			</ul>
			</div>
		</div>
		...
		<div>
		<ul class="menu-bar navbar-fixed-top">
